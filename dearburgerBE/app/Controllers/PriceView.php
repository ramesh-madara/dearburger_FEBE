...
class PriceView extends BaseController
{
    ...
    public function item_price_view()
    {
        $crud = new GroceryCrud();

        $crud->setTheme('datatables');
        $crud->setTable('tblitemprice');
        $crud->setSubject('ItemPrices');
        $crud->setRelation('menuItemID', 'tblmenuitems', 'menuItemName');
        $crud->setRelation('itemPriceOptionsID', 'tblitempriceoptions', 'PriceVariation');
