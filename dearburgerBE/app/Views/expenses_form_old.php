...
<body class="hold-transition sidebar-mini">
            ...
            <section class="content">
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <!-- jquery validation -->
                            <a href="/addExpenses/stats">Stats📈 </a>
                                ...
                                <form id="quickForm">
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input required type="date" name="date" class="form-control expenses-input" id="" placeholder="01/01/2023">
                                        </div>
    ...
    <!-- <script src="<?php echo base_url() ?>assets/custom_js/add_expenses.js"></script> -->
    <!-- Bootstrap 4 -->
